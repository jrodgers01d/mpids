...
from serial_code_using_pandas import *
...
def main():
  ...
  print_to_file("\n#Most similar documents in '{}' using the threshold {} with the corresponding similarity socres are listed below:\n".format(directory_dataset, threshold), file_results)
